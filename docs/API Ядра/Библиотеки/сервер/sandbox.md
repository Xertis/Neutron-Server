...
```lua
-- Загружает и возвращает контроллер на основе пути к файлу .lua (или можно передать таблицу с описанными ивентами), который управляет серверной логикой инвентарей, похож на файлы логики макетов .xml.lua
